...
{
	printk("%s: Entering Compare and Swap Module!\n", __func__);
	counter = 0;
	init_lock(&c_lock);
	thread1 = kthread_run(work_fn, NULL, "compare_and_swap_function");
	thread2 = kthread_run(work_fn, NULL, "compare_and_swap_function");
	thread3 = kthread_run(work_fn, NULL, "compare_and_swap_function");
	thread4 = kthread_run(work_fn, NULL, "compare_and_swap_function");
	return 0;
}
...
static void __exit my_mod_exit(void)
{
	...
	printk("%s: Exiting Compare and Swap Module!\n", __func__);
}
